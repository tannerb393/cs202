...
EXAMPLES:      #include "structures_v5.h"
PARAMETERS:    none 
EXIT CODES:    NA
COMPILATION:   used vim and makefile which includes (.cpp :
	            g++ -o $* $*.cpp -std=c++11 -std=gnu++11
NOTES:        second version of the header file which now includes definitions for an array size finder
		,a location printer, and defining max size. #ifndef also helps to avoid multiple calls to
		header file inside the .cpp file.
MODIFICATION HISTORY:
Author              Date        Modification(s)
-------------   -----------    ---------------
Tanner_Benavides  09-21-2017     1.0 / structures_v4.h
Tanner_Benavides  09-21-2017     2.0 / structures_v5.h
----------------------------------------------------------------------------- */
